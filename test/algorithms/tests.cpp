...
std::string batchschedulingsolver::get_path(
...
std::vector<TestInstancePath> batchschedulingsolver::get_test_instance_paths(
...
std::vector<TestParams> batchschedulingsolver::get_test_params(
...
const Instance batchschedulingsolver::get_instance(
...
const Solution batchschedulingsolver::get_solution(
