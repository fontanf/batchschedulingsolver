...
Output batchschedulingsolver::milp_rank_based_parallel(
        const Instance& instance,
        const MilpRankBasedParameters& parameters)
{
    throw std::invalid_argument("milp_rank_based_parallel: not implemented");
    return Output(instance);
}

Output batchschedulingsolver::milp_rank_based_parallel_release_dates(
        const Instance& instance,
        const MilpRankBasedParameters& parameters)
{
    throw std::invalid_argument("milp_rank_based_parallel_release_dates: not implemented");
    return Output(instance);
}
